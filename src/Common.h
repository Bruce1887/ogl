...
// ============================================================================
// All screen sizes and UI-related dimensions are centralized here.
// UI components should reference these values for consistency.
// The UI is designed for a reference resolution and scales to any size.

// --- Window Dimensions ---
extern GLsizei WINDOW_X;  // Window width (set in Common.cpp)
extern GLsizei WINDOW_Y;  // Window height (set in Common.cpp)
