...
int main(int, char **)
{
    ...
    // Model gran((MODELS_DIR / "gran" / "gran.obj")); // gran som trädet gran
        ...
        while (!glfwWindowShouldClose(g_window))
        {
            ...
            // // ---- ADD THIS ----
            // float terrainY = chunkManager.getPreciseHeightAt(
            //     scene.m_activeCamera.m_Position.x,
            //     scene.m_activeCamera.m_Position.z
            // );


            // scene.m_activeCamera.m_Position.y = terrainY + 1.8f;
            // // -------------------
